...
func (ui *ChatUI) initializeViewport() {
	...
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+V")+" - Paste from clipboard"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Alt+V")+" - Toggle voice mode"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+T")+" - Voice recording"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+N")+" - Skip to next TTS response"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+I")+" - Interrupt TTS playback"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+Q")+" - Show TTS queue status"))
