...
func (ui *ChatUI) initializeViewport() {
	...
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("F1")+" - Voice recording trigger"))
	viewport = append(viewport, bulletStyle.Render("• "+highlightStyle.Render("Ctrl+T")+" - Alternative voice trigger"))
