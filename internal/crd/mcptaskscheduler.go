...
type EventTrigger struct {
	...
	// +kubebuilder:validation:Enum=k8s-event;webhook;file-watch
...
type TriggerCondition struct {
	...
	// +kubebuilder:validation:Enum=equals;notEquals;contains;notContains;regex;exists;notExists
...
type WorkflowStep struct {
	...
	// +kubebuilder:validation:Enum=Always;OnSuccess;OnFailure;OnCondition
...
type TemplateParameter struct {
	...
	// +kubebuilder:validation:Enum=string;int;bool;array;object
